...
class RoomController extends Controller
{
    ...
    {
        $themeVersion = DB::table('basic_settings')
            ->where('uniqid', 12345)
            ->pluck('theme_version')->first();
        ...
        if ($themeVersion == 'theme_three' || $themeVersion == 'theme_four') {
        ...
        if ($themeVersion == 'theme_three' || $themeVersion == 'theme_four') {
            $imgName = UploadFile::store(('assets/img/room-category/'), $request->file('image'));
        }
    ...
    public function updateCategory(Request $request)
    {
        ...
        $category = RoomCategory::find($request->category_id);
        if ($request->hasFile('image')) {
            $newImage = $request->file('image');
            $oldImage = $category->image;
            $imgName = UploadFile::update(public_path('assets/img/room-category/'), $newImage, $oldImage);
        }
    ...
    public function deleteCategory(Request $request)
    {
        ...
        @unlink(public_path('assets/img/room-category/') . $roomCategory->image);
        $roomCategory->delete();
    ...
    public function updateBooking(AdminRoomBookingRequest $request)
    {
        ...
        session()->flash('success', 'Rental information has been updated.');
    ...
    public function deleteBooking(Request $request, $id)
    {
        ...
        session()->flash('success', 'Room rental record deleted successfully!');
    ...
    public function bulkDeleteBooking(Request $request)
    {
        ...
        session()->flash('success', 'Room rental records deleted successfully!');
    ...
    public function makeBooking(AdminRoomBookingRequest $request)
    {
        ...
        session()->flash('success', 'Room has rent.');

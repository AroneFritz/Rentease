...
@section('content')
  <div class="page-header">
    <h4 class="page-title">{{ __('New Rental') }}</h4>
    ...
    <div class="col-md-12">
      <div class="card">
        <div class="card-header">
          <div class="card-title d-inline-block">{{ __('Make New Rentals') }}</div>
        </div>
                ...
                <div class="row">
                  ...
                  <div class="col-lg-6">
                    <div class="form-group">
                      ...
                      <input type="text" class="form-control" placeholder="{{ __('Number of Days') }}" id="night" name="nights" value="{{ old('nights') }}" readonly>
                      @error('nights')
                        <p class="mt-1 mb-0 ml-1 text-danger">{{ $message }}</p>
                      @enderror
                  ...
                  <div class="col-lg-6">
                    <div class="form-group">
                      ...
                      <input type="email" class="form-control" placeholder="{{ __('Enter Tenant Email') }}" name="customer_email" value="{{ old('customer_email') }}">

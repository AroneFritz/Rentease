...
@section('content')
  <div class="page-header">
    ...
    <ul class="breadcrumbs">
      ...
      <li class="nav-item">
        <a href="{{ route('admin.packages_management.packages') }}">{{ __('Property') }}</a>
      </li>
      <li class="separator">
        <i class="flaticon-right-arrow"></i>
      </li>
    ...
    <div class="col-md-12">
      <div class="card">
        <div class="card-header">
          <div class="card-title d-inline-block">{{ __('Add New Property') }}</div>
                      ...
                      <div class="row mt-2">
                        <div class="col-lg-12">
                          <input type="number" step="0.01" id="fixed-price" class="form-control d-none"
                            name="fixed_package_price" placeholder="Enter Property Price (Fixed)">

                          <input type="number" step="0.01" id="per-person-price" class="form-control d-none"
                            name="per_person_package_price" placeholder="Enter Property Price (Per Person)">
                        </div>
                      </div>
                    </div>
                  </div>
                  ...
                  <div class="col-lg-6">
                    <div class="form-group">
                      ...
                      <p id="daywise-text" class="mt-2 mb-0 text-warning d-none">
                        {{ __('Plans need to be added according to per day, after adding property.') }}
                      </p>

                      <p id="timewise-text" class="mt-2 mb-0 text-warning d-none">
                        {{ __('Plans need to be added according to per time frame, after adding property.') }}
                      </p>
                    </div>
                  </div>
                  <div class="col-lg-6">
                    <div class="form-group">
                      <label>{{ __('Landlord') }}</label>
                      ...
                      <p class="text-warning">
                        {{ __('if you do not select any landlord , then this property will be for Admin.') }}</p>
                    </div>
                  </div>
                </div>

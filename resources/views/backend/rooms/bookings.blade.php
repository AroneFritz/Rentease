      ...
      <div class="card">
          ...
          <div class="row">
            ...
            <div class="col-md-6">
              <form
                ...
                <div class="row">
                  <div class="col-lg-6">
                    <input name="booking_no" type="text" class="form-control" placeholder="Search By Rental No."
        ...
        <div class="card-body">
          <div class="row">
            <div class="col-lg-12">
              @if (count($bookings) == 0)
                <h3 class="text-center mt-2">{{ __('NO ROOM RENTALS FOUND!') }}</h3>
              @else

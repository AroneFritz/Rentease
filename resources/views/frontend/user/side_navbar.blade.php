  ...
  <div class="user-sidebar">
    <ul class="links">
      ...
      <li
        ...
        <a href="{{ route('user.room_bookings') }}">{{ __('Room Rentals') }}</a>
      </li>

      <li
        class="{{ request()->routeIs('user.package_bookings') || request()->routeIs('user.package_booking_details') ? 'active-menu' : '' }}">
        <a href="{{ route('user.package_bookings') }}">{{ __('Property Rentals') }}</a>
      </li>

      <li class="{{ request()->routeIs('user.wishlists') ? 'active-menu' : '' }}">
        <a href="{{ route('user.wishlists') }}">{{ __('My Wishlist') }}</a>
      </li>

...
@section('content')
  <div class="page-header">
    ...
    <ul class="breadcrumbs">
      ...
      <li class="nav-item">
        <a href="http://localhost/rentease/vendor/package-management/packages">{{ __('Property') }}</a>
      </li>
      <li class="separator">
        <i class="flaticon-right-arrow"></i>
      </li>
    ...
    <div class="col-md-12">
      <div class="card">
        <div class="card-header">
          <div class="row">
            <div class="col-lg-4">
              <div class="card-title d-inline-block">{{ __('Property\'s Monthly Plans') }}</div>
            </div>
            <div class="col-lg-3">
            ...
            <div class="col-lg-5 mt-2 mt-lg-0">
              <a href="#" class="btn btn-primary btn-sm planBtn float-lg-right float-left"
                data-id="{{ $package->id }}" data-plan_type="{{ $package->plan_type }}">Add Plan</a>
        ...
        <div class="card-body">
          <div class="row">
            <div class="col-lg-12">
              @if (count($plans) == 0)
                <h3 class="text-center">{{ __('NO PLAN FOUND FOR THIS PROPERTY!') }}</h3>
              @else
  ...
  {{-- edit modal --}}
  @include('vendors.packages.edit_daywise_plan')

  {{-- add package plan modal (daywise) --}}
  @include('vendors.packages.create_daywise_plan')
@endsection

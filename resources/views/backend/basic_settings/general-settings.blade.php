            ...
            <div class="row">
              ...
              <div class="col-lg-8 mx-auto">
                ...
                <div class="row">
                  <div class="col-md-12">
                    <div class="form-group">
                      <label for="">{{ __('Property Rental Commission') }} (%)</label>
                      <input type="number" class="form-control" name="package_booking_commission"
                        ...
                        placeholder="{{ __('Enter Property Rental Commission') }}">

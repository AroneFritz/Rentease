  ...
  <div class="modal-dialog modal-dialog-centered modal-lg" role="document">
    <div class="modal-content">
      ...
      <div class="modal-body">
        <form id="ajaxForm" action="{{ route('admin.room_bookings.send_mail') }}" method="POST">
          @csrf
          <div class="form-group">
            <label for="">{{ __('Tenant Mail Address*') }}</label>
          ...
          <div class="form-group">
            ...
            <textarea class="form-control summernote" id="messageBody" name="message" placeholder="Enter Message" data-height="150"></textarea>

    ...
    <div class="modal-content">
      ...
      <div class="modal-body">
        <form id="daywise-plan-ajax-form" class="modal-form"
          action="{{ route('vendor.packages_management.store_daywise_plan') }}" method="POST">
          @csrf
          ...
          <div class="form-group {{ $language->direction == 1 ? 'rtl text-right' : '' }}">
            ...
            <input type="number" class="form-control" name="day_number" placeholder="Enter Day Number">
          ...
          <div class="form-group {{ $language->direction == 1 ? 'rtl text-right' : '' }}">
            ...
            <textarea class="form-control summernote" name="plan" data-height="100"></textarea>

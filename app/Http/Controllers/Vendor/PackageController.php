...
class PackageController extends Controller
{
    ...
    public function deletePackage(Request $request)
    {
        ...
        if ($package->packageLocationList()->count() > 0) {
            session()->flash('warning', 'First delete all the locations of this property!');

            return redirect()->back();
        }

        if ($package->packagePlanList()->count() > 0) {
            session()->flash('warning', 'First delete all the plans of this property!');
    ...
    public function bulkDeletePackage(Request $request)
    {
        ...
        foreach ($ids as $id) {
            ...
            if ($package->packageLocationList()->count() > 0) {
                session()->flash('warning', 'First delete all the locations of those property!');
            ...
            if ($package->packagePlanList()->count() > 0) {
                session()->flash('warning', 'First delete all the plans of those property!');

  ...
  <div class="row">
          ...
          <div class="row">
            <div class="col-md-6">
              <div class="card-title d-inline-block">
                {{ __('Rental Id') . ' #' }} {{ $details->booking_number }}
              </div>
            </div>
            <div class="col-md-6">
        ...
        <div class="card-body">
          <div class="payment-information">
            ...
            @if ($packageCategoryName != null)
              <div class="row">
                <div class="col-lg-4">
                  <strong class="text-capitalize">{{ __('property type :') }}</strong>
                </div>
            ...
            <div class="row">
              <div class="col-lg-4">
                <strong class="text-capitalize">{{ __('Received by Landlord') . ' : ' }}</strong>
              </div>
              <div class="col-lg-8">
    ...
    @if (!is_null($details->vendor_id))
      <div class="col-md-3">
        <div class="card">
          <div class="card-header">
            <div class="card-title d-inline-block">{{ __('Landlord Information') }}</div>
          </div>
          <div class="card-body">
            <div class="payment-information">
              <div class="row">

...
@section('content')
  <div class="page-header">
    <h4 class="page-title">{{ __('Registered Landlord') }}</h4>
    <ul class="breadcrumbs">
      ...
      <li class="nav-item">
        <a href="#">{{ __('Landlord Management') }}</a>
      </li>
      <li class="separator">
        <i class="flaticon-right-arrow"></i>
      </li>
      <li class="nav-item">
        <a href="#">{{ __('Registered Landlord') }}</a>
      </li>
    </ul>
  </div>
    ...
    <div class="col-md-12">
      <div class="card">
        <div class="card-header">
          <div class="row">
            <div class="col-lg-4">
              <div class="card-title">{{ __('All Landlords') }}</div>
            </div>
            ...
            <div class="col-lg-4">
              <a href="{{ route('admin.vendor_management.add_vendor') }}"
                class="btn mt-1 btn-secondary btn-sm float-lg-right float-left ml-1 mr-1"><i class="fas fa-plus"></i> {{ __('Add Landlord') }}</a>
        ...
        <div class="card-body">
          <div class="row">
            <div class="col-lg-12">
              @if (count($vendors) == 0)
                <h3 class="text-center">{{ __('NO LANDLORD FOUND') . '!' }}</h3>
              @else
